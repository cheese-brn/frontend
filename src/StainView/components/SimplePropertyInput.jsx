  ...
  return (
    ...
    >
      <div style={{ display: 'flex' }}>
        ...
        {!readOnly && (
          <Button variant="contained" color="success" sx={smallButtonStyle}>
            +
          </Button>
        )}
        {!readOnly && (
          <Button variant="contained" color="error" sx={smallButtonStyle}>
            -
          </Button>
        )}
      </div>
        ...
        >
          {readOnly && (
            <Typography variant={'p'}>{`${
              subProp.name ? `${subProp.name}: ` : ``
            }${subProp.value}`}</Typography>
          )}
          {!readOnly && (
            <>
              <TextField
